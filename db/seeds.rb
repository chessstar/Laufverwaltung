...
Shoe.create(:brand => "Asics", :description => "GT-2130", :user_id => 1, :fullname => 'Asics GT-2130', :viewable => 1)
Shoe.create(:brand => "Asics", :description => "GT-2170", :user_id => 1, :fullname => 'Asics GT-2170', :viewable => 1)
Shoe.create(:brand => "Puma", :description => "Supernova Cushion 6", :user_id => 1, :fullname => 'Puma Supernova Cushion 6', :viewable => 1)
Shoe.create(:brand => "Brooks", :description => "Adrenaline 11", :user_id => 1, :fullname => 'Brooks Adrenaline 11', :viewable => 1)
Shoe.create(:brand => "Mizuno", :description => "Wave Inspire 7", :user_id => 2, :fullname => 'Mizuno Wave Inspire 7', :viewable => 1)
Shoe.create(:brand => "Nike", :description => "Free 3.1", :user_id => 2, :fullname => 'Nike Free 3.1', :viewable => 1)
